...
## 2. Traducción de lo que ven los visitantes (manual, pestaña Textos del widget)
...
**Textos del widget** (ver [Textos del widget](05-widget-text.md)) —
están en inglés por defecto.
